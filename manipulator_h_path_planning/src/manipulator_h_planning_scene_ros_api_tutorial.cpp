...
{
  ros::init(argc, argv, "manipulator_h_planning_scene_ros_api_tutorial");
  ...
  attached_object.object.header.frame_id = "end_link";
  ...
  ROS_INFO("Adding the object into the world at the location of the end link of the manipulator.");
  ...
  //
  // While most of this tutorial uses the latter (last) mechanism (given the long sleeps
  // took for visualization purposes, asynchronous updates do not pose a problem),
  // his use is perfectly justified to replace the planning_scene_diff_publisher
  ...
  ROS_INFO("Attaching the object to the end effector and removing it from the world.");
  ...
  detach_object.link_name = "end_link";
